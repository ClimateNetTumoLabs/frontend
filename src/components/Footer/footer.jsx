            ...
            <div className="container-fluid d-flex justify-content-center">
                <div className='col-6'>
                    ...
                    <div className={`social-icon ${styles.social_icons_block}`}>
                        <a className={styles.social_icon} href="https://facebook.com"><FontAwesomeIcon icon={faFacebook} /></a>
                        <a className={styles.social_icon} href="https://twitter.com"><FontAwesomeIcon icon={faTwitter} /></a>
                        <a className={styles.social_icon} href="https://instagram.com"><FontAwesomeIcon icon={faInstagram} /></a>
                    </div>
                </div>

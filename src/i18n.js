        ...
        en: {
            translation: {
                about: {
                    ...
                    uv_intro: "We measure light intensity and spectral information, making it valuable for various applications.",
                    uv_intro2: "UVA and UVB are two types of ultraviolet (UV) radiation emitted by the sun, but they differ in their wavelength and impact on human health. Here's an in-depth look at each:",
                    ...
                    uva3: "While UVA is less energetic than UVB, it contributes significantly to skin aging and wrinkles. It can also weaken the immune system and increase the risk of skin cancer",
                    uvb: "Wavelength 280-315 nm",
                    uvb2: "UVB rays have a shorter wavelength than UVA and do not penetrate as deeply into the skin, affecting mainly the outer layer (epidermis).",
                    uvb3: "UVB is more energetic and primarily responsible for sunburn. It plays a significant role in the development of skin cancer and can damage the DNA in skin cells. UVB also contributes to the production of vitamin D in the skin.",
        ...
        hy: {
            translation: {
                about: {
                    ...
                    uv_intro2: "UVA-ն և UVB-ն արևի կողմից արտանետվող ուլտրամանուշակագույն ճառագայթման երկու տեսակ են, սակայն դրանք տարբերվում են իրենց ալիքի երկարությամբ և մարդու առողջության վրա ունեցած ազդեցությամբ: Ահա յուրաքանչյուրի մասին մանրամասներ:",
                    ...
                    uva3: "Չնայած UVA-ն ավելի քիչ էներգետիկ է, քան UVB-ն, այն զգալիորեն նպաստում է մաշկի ծերացմանը և կնճիռներին: Այն նաև կարող է թուլացնել իմունային համակարգը և մեծացնել մաշկի քաղցկեղի առաջացման վտանգը:",
                    uvb: "Ալիքի երկարություն 280-315 նմ",
                    uvb2: "UVB ճառագայթներն ունեն ավելի կարճ ալիքի երկարություն, քան UVA-ն և այնքան խորը չեն թափանցում մաշկի մեջ ՝ ազդելով հիմնականում արտաքին շերտի վրա (էպիդերմիս):",
                    uvb3: "UVB-ն ավելի շատ էներգիա ունի և հիմնականում պատասխանատու է արևի այրվածքների համար: Այն կարևոր դեր է խաղում մաշկի քաղցկեղի զարգացման գործում և կարող է վնասել ԴՆԹ-ն մաշկի բջիջներում: UVB-ն նույնպես նպաստում է մաշկի մեջ վիտամին D-ի արտադրությանը:",
                ...
                banner: {
                    ...
                    text: {
                        ...
                        3: 'Իրական ժամանակում հետևեք կլիմայական փոփոխություններին Հայաստանի մարզերում։',
                    },
                },
                scrollableSection: {
                    ...
                    sections: [
                        {
                            ...
                            partner2: "ԹՈՒՄՈ արկղերը էժան և հեշտ տեղադրվող սարքեր են, որոնք կառուցված են բեռնափոխադրման տարաներից: Այս ինքնավար ուսումնական կենտրոնները, որոնք ռազմավարականորեն տեղակայված են այնպես, որ Հայաստանի յուրաքանչյուր դեռահաս կարողանա դրանց հասնել 40 րոպեում կամ ավելի քիչ, հագեցած են ամենաժամանակակից աշխատատեղերով և սարքավորումներով և կարող են ընդունել շաբաթական մինչև 320 սովորող: Այս արկղերը հնարավորություն են տալիս մուտք գործել Թումո ծրագիր և ավտոբուսների ամբողջ ցանց: Այս արբանյակային վայրերը հիմք են հանդիսանում Climate Net սարքերի համար: Սարքերը տեղադրված են այդ արկղերի վրա ամբողջ երկրում, որպեսզի մեզ տրամադրեն տեղական և ճշգրիտ տվյալներ։"
                        },
                        {
                            title: "Ուսանողներ:",
